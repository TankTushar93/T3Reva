...
const Needhelp = () => {
  ...
  return (
    <div style={{backgroundColor:background === 'Light' ? '#fff' : lighten(0.26,col)}} className={`px-4 sm:px-6 ${layout === 'Wide' ? 'lg:px-24' : 'lg:px-4'}  relative  pt-24 pb-10 text-center`}>
      {/* Background vertical lines */}
      {!loading && background === 'Light' && layout === 'Wide' &&(
