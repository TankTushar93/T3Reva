  ...
  return (
    <div className="bg-white  shadow-md overflow-hidden flex flex-col h-full">
      ...
      <div className="p-6  flex flex-col flex-grow">
        ...
        {/* Read More Link */}
        <a href="#" className="text-blue-500 font-semibold mb-5 flex items-center ">
          Read more
  ...
  return (
    <div className="bg-white py-16 px-4 sm:px-6 lg:px-8">
      ...
      <div className="flex  justify-center mt-10 items-center gap-2">
            <button type="button" aria-label="Previous" className="mr-4 cursor-pointer">
            ...
            <div className="flex gap-2 text-gray-500 text-sm md:text-base">
                <button type="button" className="flex items-center justify-center active:scale-95 w-9 md:w-12 h-9 md:h-12 aspect-square bg-indigo-500 text-white rounded-md transition-all">1</button>
                <button type="button" className="flex items-center justify-center active:scale-95 w-9 md:w-12 h-9 md:h-12 aspect-square bg-white border border-gray-200 rounded-md hover:bg-gray-100/70 transition-all">2</button>
            ...
            <button type="button" aria-label="Next" className="ml-4 cursor-pointer">
                <svg width="9" height="16" viewBox="0 0 12 18" fill="none" xmlns="http://www.w3.org/2000/svg">
